namespace Loupedeck.PiholePlugin.Actions
{
    ...
    internal class DnsQueriesAllTypes : PluginDynamicCommand
    {
        // Assign variables

        private PiholePlugin _plugin;
        // build action
        public DnsQueriesAllTypes() : base() => this.AddParameter("dnsqueriesalltypes", "Display DNS queries all types", groupName: "Display");
