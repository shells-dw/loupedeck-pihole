namespace Loupedeck.PiholePlugin.Actions
{
    ...
    internal class DnsQueriesToday : PluginDynamicCommand
    {
        // Assign variables

        private PiholePlugin _plugin;
        // build action
        public DnsQueriesToday() : base() => this.AddParameter("dnsqueriestoday", "Display DNS Queries Today", groupName: "Display");
