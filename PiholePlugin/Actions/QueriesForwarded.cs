namespace Loupedeck.PiholePlugin.Actions
{
    ...
    internal class QueriesForwarded : PluginDynamicCommand
    {
        // Assign variables

        private PiholePlugin _plugin;
        // build action
        public QueriesForwarded() : base() => this.AddParameter("queriesforwarded", "Display Queries Forwarded", groupName: "Display");
