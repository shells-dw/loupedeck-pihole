namespace Loupedeck.PiholePlugin.Actions
{
    ...
    internal class DomainsBlocked : PluginDynamicCommand
    {
        // Assign variables

        private PiholePlugin _plugin;
        // build action
        public DomainsBlocked() : base() => this.AddParameter("domainsblocked", "Display Domains Blocked", groupName: "Display");
