namespace Loupedeck.PiholePlugin.Actions
{
    ...
    internal class UniqueDomains : PluginDynamicCommand
    {
        // Assign variables

        private PiholePlugin _plugin;
        // build action
        public UniqueDomains() : base() => this.AddParameter("uniquedomains", "Display Unique Domains", groupName: "Display");
        ...
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
            ...
            using (var bitmapBuilder = new BitmapBuilder(imageSize))
            {
                ...
                bitmapBuilder.DrawText(String.Format("{0:n0}", Int32.Parse(Globals.PiDump.unique_domains)), x: 40, y: 5, width: 0, height: 40, fontSize: 15, color: BitmapColor.White);
                bitmapBuilder.DrawText("Unique\ndomains", x: 5, y: 35, width: 70, height: 40, fontSize: 12, color: BitmapColor.White);
