namespace Loupedeck.PiholePlugin.Actions
{
    ...
    internal class UniqueClients : PluginDynamicCommand
    {
        // Assign variables

        private PiholePlugin _plugin;
        // build action
        public UniqueClients() : base() => this.AddParameter("uniqueclients", "Display Unique Clients", groupName: "Display");
        ...
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
            ...
            using (var bitmapBuilder = new BitmapBuilder(imageSize))
            {
                ...
                bitmapBuilder.DrawText(String.Format("{0:n0}", Int32.Parse(Globals.PiDump.unique_clients)), x: 40, y: 5, width: 0, height: 40, fontSize: 15, color: BitmapColor.White);
                bitmapBuilder.DrawText("Unique\nclients", x: 5, y: 35, width: 70, height: 40, fontSize: 12, color: BitmapColor.White);
