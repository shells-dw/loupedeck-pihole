namespace Loupedeck.PiholePlugin.Actions
{
    ...
    internal class AdsBlockedToday : PluginDynamicCommand
    {
        // Assign variables

        private PiholePlugin _plugin;
        // build action
        public AdsBlockedToday() : base() => this.AddParameter("adsblockedtoday", "Display Ads Blocked Today", groupName: "Display");
