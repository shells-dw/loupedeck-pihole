namespace Loupedeck.PiholePlugin.Actions
{
    ...
    internal class ClientsEverSeen : PluginDynamicCommand
    {
        // Assign variables

        private PiholePlugin _plugin;
        // build action
        public ClientsEverSeen() : base() => this.AddParameter("clientseverseen", "Display Clients ever seen", groupName: "Display");
